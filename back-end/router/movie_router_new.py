...
def create_movie(movie: MovieCreate, db: Session = Depends(get_db)):
    ...
    - **actor**: 주연배우 (필수)
    - **total_time**: 총 재생시간 (필수)
    - **category**: 카테고리 (필수)
    - **url**: 유튜브 URL (필수)
    - **bookmark**: 북마크 여부 (선택, 기본값: False)
    """
...
def read_movies(
    ...
    """
    # SQL: SELECT * FROM movies LIMIT 100 OFFSET 0
...
# 배우별 영화 조회 API - 특정 배우의 영화들만 가져오기
