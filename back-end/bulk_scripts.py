...
# 서버 URL
url = "https://yousync-fastapi-production.up.railway.app/scripts/"
...
all_data = [
    {
        ...
        "url": "https://youtu.be/3mUg7PmCsNs",
        "actor_pitch_values": [0],
        "background_pitch_values": [0]
    },
    {
        "actor": "string",
        "start_time": 4.0,
...
for idx, item in enumerate(all_data, 1):
    ...
    if response.status_code == 200 or response.status_code == 201:
        ...
        print(f"[{idx}] 업로드 실패: {response.status_code}, {response.text}")